...
<?php
  ...
  $edit    = "SELECT * FROM siswa WHERE id_siswa = '$id_siswa' AND st_siswa='AKTIF'";
...
?>
        ...
        <tbody>
          ...
          error_reporting(0);
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM siswa WHERE st_siswa='AKTIF'")or die(mysqli_error());
