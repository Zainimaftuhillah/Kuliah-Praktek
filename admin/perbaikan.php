...
<div class="col-md-14" style="padding:1px">
  <ol class="breadcrumb" style="margin:0;border-radius:0;">
    <li class="active"><a href="admin.php?content=dashboard">Dashboard</a> / Perbaikan Siswa</li>
  </ol>
</div>
<br>
 ...
 -->
      ...
      <table class="table table-hover">
        ...
        <!--     <th><font color="white">perbaikan 1</font></th> -->
                    ...
                    { 
                      ...
                      while($data = mysqli_fetch_array($query)){  
                        ...
                        echo '<td>'.$data['date'].'</td>';
                         ...
                         echo '<td  width="10"><center><a data-toggle="tooltip" data-placement="left" title="Lihat Data Lengkap" href=admin.php?content=edit_perbaikan&&id_perbaikan='.$data['id_perbaikan'].'><i class="fa fa-edit fa-fw"></i></a></td>';
                        echo '<td  width="10"><a data-toggle="tooltip" data-placement="left" title="Delete" href=../config/delete_perbaikan.php?id_perbaikan='.$data['id_perbaikan'].'><i class="fa fa-trash fa-fw"></i></a></td>';
                        echo '</tr>';
