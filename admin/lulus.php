...
<html>
<head>
  <title>Print Data Siswa Lulus</title>
  <meta charset="utf-8">
...
<?php
  ...
  $edit    = "SELECT * FROM siswa WHERE id_siswa = '$id_siswa' AND st_siswa='LULUS'";;
...
?>
        ...
        <tbody>
          ...
          error_reporting(0);
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM siswa WHERE st_siswa='LULUS'")or die(mysqli_error());
