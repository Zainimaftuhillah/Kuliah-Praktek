...
<div class="col-md-14" style="padding:1px">
  <ol class="breadcrumb" style="margin:0;border-radius:0;">
    <li class="active"><a href="admin.php?content=dashboard">Dashboard</a> / Data Siswa</li>
  </ol>
</div>
<br>
...
<!-- <div class="dropdown">
    ...
    <button type="button" class="btn btn-secondary">SISWA<i class="fa fa-plus-circle fa-fw"></i></button></a>
  ...
  <a href="admin.php?content=cetak_spp">
...
<!--             <th><font color="white">NISN</font></th>
            ...
            <th><font color="white">SPP </font></th>
        ...
        <tbody>
          ...
          error_reporting(0);
            ...
            NIPD LIKE '%$pencarian%' ORDER BY id_siswa DESC";
                ...
                $query = "SELECT * FROM siswa WHERE id_siswa ORDER BY id_siswa DESC LIMIT $posisi, $batas ";
                $queryJml = "SELECT * FROM siswa WHERE id_siswa ORDER BY id_siswa DESC";
                $no = $posisi + 1;
              }
            } else {
              $query = "SELECT * FROM siswa WHERE id_siswa ORDER BY id_siswa DESC LIMIT $posisi, $batas ";
