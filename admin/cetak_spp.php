         ...
         <!--    <div class="panel-group">
            <div class="panel panel-primary"> -->
              <div class="panel-body">
                <table class="table">
                  <tr>
                  <th><br><p align="center"><img src="../admin/logoo.png" height="150"></p></th>
                  <td><br><p align="center">
                          <font size="6px"><b>LAPORAN SPP SMP CAWANG BARU</b></font><br>Jl. Cawang Baru No.543, RT.7/RW.10, Cipinang Cempedak, Kecamatan Jatinegara, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13340</p></td>
                  </tr>
                </table>
    ...
    <!--         <th><font color="white">Tempat Lahir</font></th>
        ...
        <tbody>
          ...
          error_reporting(0);
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM siswa")or die(mysqli_error());
