        ...
        <tbody>
          ...
          error_reporting(0);
           ...
           $batas  = 5;
            ...
            if($pencarian !=''){
            $sql = "SELECT * FROM siswa WHERE kelas='IX' AND nama LIKE '%$pencarian%' OR 
            kelas LIKE '%$pencarian%' OR 
            NISN LIKE '%$pencarian%' OR 
            NIPD LIKE '%$pencarian%' ORDER BY kelas='IX' DESC";
            
                $query = $sql;
                $queryJml = $sql;
              } else {
                $query = "SELECT * FROM siswa WHERE kelas='IX' ORDER BY kelas='IX' DESC LIMIT $posisi, $batas ";
                $queryJml = "SELECT * FROM siswa WHERE kelas='IX' ORDER BY kelas=IX' DESC";
                $no = $posisi + 1;
              }
            } else {
              $query = "SELECT * FROM siswa WHERE kelas='IX' ORDER BY kelas='IX' DESC LIMIT $posisi, $batas ";
     ...
     if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        <div style="float:left;">
          <ul class="pagination pagination-sm" style="margin: 0">
            ...
            for ($i=1; $i <= $jml_hal; $i++) {
              if ($i != $hal) {
                echo "<li><a href=\"admin.php?content=sembilan&&hal=$i\">$i</a></li>";
              } else {
