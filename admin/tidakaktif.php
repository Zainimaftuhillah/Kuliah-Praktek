...
<html>
<head>
  <title>Print Data Siswa Aktif</title>
  <meta charset="utf-8">
...
<?php
  ...
  $edit    = "SELECT * FROM siswa WHERE id_siswa = '$id_siswa' AND st_siswa='TIDAK AKTIF'";;
...
?>
        ...
        <tbody>
          ...
          error_reporting(0);
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM siswa WHERE st_siswa='TIDAK AKTIF'")or die(mysqli_error());
